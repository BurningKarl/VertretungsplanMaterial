 ...
 */
public class SubstituteScheduleAlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
         ...
         */
        Intent service = new Intent(context, SubstituteScheduleNotificationService.class);
